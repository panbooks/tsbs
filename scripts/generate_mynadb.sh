#!/bin/bash
# Generate sample devops data in InfluxDB line protocol format for MynaDB
#
# Usage:
#   ./scripts/generate_mynadb.sh [OPTIONS]
#
...
#   OUTPUT      - Output file path (default: /tmp/mynadb-data.txt)
...
SEED="${SEED:-123}"
OUTPUT="${OUTPUT:-/tmp/mynadb-data.txt}"
